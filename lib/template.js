...
const _templateSchemaData = fs.readFileSync(`${__dirname}/../schema/template.json`);
    ...
    _handleParsed(parsed, typeSchemas) {
        ...
        const schema = parsed.reduce((acc, curr) => {
            ...
            case '#': {
                ...
                const defType = (this.definitions[defName] && this.definitions[defName].type) || 'array';
                const newDef = Object.assign({ type: defType }, this.definitions[defName]);
